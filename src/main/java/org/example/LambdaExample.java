...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        repository.select(usersAgeGreaterThanFive, Comparator.comparing(User::getName));
        ...
        repository.select(usersAgeLessThanTen, Comparator.comparing(User::getAge));
        ...
        // Solved With functional interfaces declared
        Predicate<User> activeUserSortedByName = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active;
            }
        };
        repository.select(activeUserSortedByName, Comparator.comparing(User::getName));
        ...
        // Solved With functional interfaces declared
        Predicate<User> activeUserAgeGreateThan8 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active && user.age > 8;
            }
        };
        repository.select(activeUserAgeGreateThan8, Comparator.comparing(User::getName));
